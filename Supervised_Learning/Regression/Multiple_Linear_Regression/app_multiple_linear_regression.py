...
#Dataset Preview#
st.markdown('<div class="card" style="text-align:center"><b>Dataset Preview <b></div>', unsafe_allow_html=True)
...
#Visualization #
st.markdown('<div class= "card" style="text-align:center"> <b>Total Bill vs Tip (MLR)<b>' , unsafe_allow_html=True)
...
st.markdown('<div class= "card" style="text-align:center"><b>Model Performance<b>',unsafe_allow_html=True)
